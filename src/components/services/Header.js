// import homeimage from 'assets/img/home/homeimage.jpg'
...
//                   <img src={homeimage} className='w-2/5 h-auto object-cover ml-auto mt-32'/>
//                 </div>
//             </div>
//           </div>
//         </div>
            ...
            <div>
              <div>
                ...
                {navigation.social.map((item) => (
                  <Link key={item.name} href={item.href} className="text-gray-900 hover:text-gray-800">
