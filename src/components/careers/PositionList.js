...
function PositionList() {
    ...
    return (
        <div className="mx-auto lg:mx-12 mx-w-full mx-12 bg-white ">
            <h2 className="text-5xl font-semibold text-gray-900 pb-8"> Open Positions</h2>
            <p className="text-2xl font-regular text-gray-900 max-w-5xl leading-10"> Le'ts write some beautiful code and make smart designs</p>
            
            {/* Filtro que muestra el listado de las locaciones de las posiciones disponibles para el equipo de trabajo componente Select.jsx */}
