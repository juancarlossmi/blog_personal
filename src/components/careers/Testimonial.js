      ...
      <div className="bg-gray-50 pb-16 lg:relative lg:z-10 lg:pb-0">
        <div className="lg:mx-12 lg:grid lg:max-w-full lg:grid-cols-3 lg:gap-8 lg:px-8">
          <div className="relative lg:-my-8">
            ...
            <div className="mx-auto lg:mx-12 max-w-md px-4 sm:max-w-3xl sm:px-6 lg:h-full lg:p-0">
          ...
          <div className="mt-12 lg:col-span-2 lg:m-0 lg:pl-8">
            <div className="mx-auto lg:mx-12 max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
              <blockquote>
                <div>
                  <svg
