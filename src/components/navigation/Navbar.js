...
import logo_gd from 'assets/img/gd.png'
...
// parte del funcionamiento del popover
const solutions = [
    {
        name: 'Casos',
...
function Navbar() {
    ...
    // la variable loading esta inicializada con "true" por defecto gracias al useState
    const [loading, setLoading] = useState(true)

    // Como identificar el comportamiento del scroll y realizar algo en cuanto al cambio del scroll
    window.onscroll = function () { scrollFunction() }

    // Funcion que permite saber si el scroll-top es mayor a 50 entonces agregamos la clase "shadow-navbar bg-white"
            ...
            <div className="px-4 sm:px-6">
                <div className="-ml-4 -mt-2 hidden lg:flex flex-wrap items-center justify-between sm:flex-nowrap md:px-14 px-2">
                    ...
                    <div className="ml-4 mt-2 flex-shrink-0">
                        ...
                        >
                            Hire us
                            <DotLoader className="ml-3 -mr-1 h-5 w-5" loading={loading_dots} size={20} color='#f2f2f2' />
                        </Link>
                    </div>
                </div>
                <div className="-ml-4 -mt-2 lg:hidden flex flex-wrap items-center justify-between sm:flex-nowrap md:px-14 px-2">
                    ...
                    <div className="ml-4 mt-2 flex-shrink-0">                        
                        ...
                        {/* condicion if simplificada = Si es open = <i className='bx bx-x text-4xl'> y si no lo es <i className='bx bx-menu text-4xl'></i> */}
                    </div>
                </div>
            </div>
        </nav>
